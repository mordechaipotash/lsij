...
def display_content_for_day(selected_day, learned_days_with_timestamp, df):
    ...
    # Display the selected day and the last learned day
    st.markdown(f"<h1 style='text-align: center;'>Day {selected_day}</h1>", unsafe_allow_html=True)
    
    # Get the last learned timestamp for the selected day
    last_learned_date = learned_days_with_timestamp.get(selected_day)
    ...
    if last_learned_date:
        ...
        st.markdown(f"<h4 style='text-align: center; color: red;'>Not Learned Yet</h4>", unsafe_allow_html=True)

    # Display the main content for the day
    st.write("Here's the content for Day", selected_day)
    st.write(day_data['Content'])
...
def main():
    ...
    # Call display_content_for_day with the correct arguments
    display_content_for_day(selected_day, learned_days_with_timestamp, df)
